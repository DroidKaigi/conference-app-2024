...
public struct SampleData {
    public let day1Data = [TimetableItem(room: "Arctic Fox", languuages: ["EN", "JA"],
                                  title: "DroidKaigiアプリで見るアーキテクチャの変遷",
                                  speaker: "Maria Rodriguez",
                                  startTime: "12:00PM",endTime: "13:00PM",isFavorite:false),
                             TimetableItem(room: "Arctic Fox", languuages: ["EN", "JA"],
                                 title: "DroidKaigiアプリで見るアーキテクチャの変遷",
                                 speaker: "Maria Rodriguez",
                                 startTime: "12:00PM",endTime: "13:00PM",isFavorite:false),
                             TimetableItem(room: "Arctic Fox", languuages: ["EN", "JA"],
    ...
    public let day2Data = [TimetableItem(room: "Arctic Fox", languuages: ["EN", "JA"],
    ...
    public let day3Data = [TimetableItem(room: "Arctic Fox", languuages: ["EN", "JA"],
